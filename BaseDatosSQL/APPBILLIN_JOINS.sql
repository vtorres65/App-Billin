...
create table DATABASEAPP.Usuario (
	...
	Select * from DATABASEAPP.Usuario as al
	INNER JOIN DATABASEAPP.ROL bl
	ON al.Contraseña_Usuario = bl.Nombre_Rol
...
create table DATABASEAPP.ROL(
	...
	Select * from DATABASEAPP.ROL
	Select * from DATABASEAPP.Cliente
	
	Select * from DATABASEAPP.ROL as al
	INNER JOIN DATABASEAPP.Cliente bl
	ON al.Nombre_Rol = bl.EstadoCliente
