...
create table DATABASEAPP.Usuario (
	...
	Insert into DATABASEAPP.Usuario(Id,Tipo_Documento,Documento_Usuario,Nombres_Usuario,Apellidos_Usuario,Telefono_Usuario,Email_Usuario,Contraseña_Usuario,Rol_Usuario)values ('12345','CC','80501312','JAIME ANDRES','DURAN CARRANZA','3053093993','jandresduranconvida@gmail.com','80501312','Admin');
	Insert into DATABASEAPP.Usuario(Id,Tipo_Documento,Documento_Usuario,Nombres_Usuario,Apellidos_Usuario,Telefono_Usuario,Email_Usuario,Contraseña_Usuario,Rol_Usuario)values ('12346','PS','39818390','PAULA ELIZABETH','MORENO GOMEZ','3053893990','paulaemorenog@gmail.com','39818390','Admin');
   	
	Select * from DATABASEAPP.Usuario
...
create table DATABASEAPP.ROL(
	...
	Insert into DATABASEAPP.Rol(Id,Id_Usuario,Nombre_Rol,Descripcion_Rol,Estado)values ('23456','12345','80501312','AdminSistema','ACTIVO');
	Insert into DATABASEAPP.Rol(Id,Id_Usuario,Nombre_Rol,Descripcion_Rol,Estado)values ('23457','12346','39818390','AdminSistema','ACTIVO');
   	
	Select * from DATABASEAPP.ROL
...
create table DATABASEAPP.UsuarioRol (
	...
	Insert into DATABASEAPP.UsuarioRol(Id
